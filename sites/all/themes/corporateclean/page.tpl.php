    ...
    <div id="slideshow">
        ...
        <div class="slider-item">
            <div class="content container_12">
                ...
                <img class="masked" src="<?php print base_path() . drupal_get_path('theme', 'corporateclean') ;?>/mockup/unity.jpg"/>
                </div>
                <h2>UNITY</h2>
<!--
...
-->
        ...
        <div class="slider-item">
            <div class="content container_12">
                ...
                <img class="masked" src="<?php print base_path() . drupal_get_path('theme', 'corporateclean') ;?>/mockup/service.jpg"/>
                </div>
                <h2>SERVICE</h2>
<!--
                <strong>General</strong><br/>
...
-->
                <br/>
		I am Responsible.<br />When anyone, anywhere, reaches out for help.  I want the hand of AA always to be there.  And for that,<br />I am responsible!
                <!--EOF:slider-item content-->
      ...
      <!--s lider-item-->
        <div class="slider-item">
            <div class="content container_12">
                ...
                <!--slider-item content-->
                <div style="float:right; padding:0 0 0 30px;">
                <img class="masked" src="<?php print base_path() . drupal_get_path('theme', 'corporateclean') ;?>/mockup/recovery.jpg"/>
                </div>
                <h2>RECOVERY</h2>
<!--
                <strong>General</strong><br/>
